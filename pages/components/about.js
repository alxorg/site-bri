...
const About = () => {
  return (
    <section className={`${styles['section-about']} container`} id="about">
      <header className={styles['section-about__hero']}>
      ...
      <img src="./hero-bri-lab.svg" alt="Desenho de uma garota sentada usando um smartphone" />
